              ...
              <>
                <p className="text-sm pb-2">
                  ...
                  <a
                    ...
                    className="text-gold"
                  >
                    Leipziger Weihnachtsmärkte 2024 von Leipzig.de{" "}
                  </a>{" "}
                  sowie{" "}
                  <a
                    target="blank"
                    href="https://www.leipzig-leben.de/weihnachtsmaerkte-leipzig-2023-alle-orte-termine/"
                    className="text-gold"
                  >
                    Leipziger Weihnachtsmärkte 2023 vom Blog
                    Leipzig-Leben.de{" "}
                  </a>. Es besteht kein Anspruch auf Vollständigkeit.
                  Weihnachtsmärkte die unter 400m Luftlinie entfernt zu
            ...
            content: (
              <>
                <p className="text-sm pb-2">
                  ...
                  >
                    Open Source {" "}
                  </a>und jede:r kann nutzen. So kannst du das Projekt
                  duplizieren und selbst weiterentwickeln oder du machst direkt
                  Vorschläge für Verbesserungen und neue Funktionen. Sicher ist
                  dir auch aufgefallen, dass viele Weihnachtsmärkte lediglich
                  ein Platzhalter-Bild haben. Dies liegt daran, dass wir nur auf
                  Bilder zurückgreifen wollen, die in Wikimedia Commons liegen,
                  dem zentralen und offenen Medienarchiv. Also knips ein Bild
                  von deinem nächsten Weihnachtsmarktbesuch und veröffentliche
                  es unter einer freien Lizenz auf{" "}
                  <a
                    target="blank"
        ...
        <Accordion
          items={[{
            ...
            content: (
              <>
                <p className="text-sm pb-2">
                  Der “Leipziger Weihnachtsmarkt-Finder” ist ein
                  Open-Source-Projekt und läuft unter einer MIT Lizenz.
                  Dementsprechend kann die Idee, aber auch der Quellcode für die
                  Umsetzung in anderen Städten kostenlos genutzt, angepasst und
                  weiterentwickelt werden. Wenn Du dich dafür interessierst,
                  schau gerne in unserem{" "}
                  <a
                    target="blank"
                    href="https://github.com/codeforleipzig/weihnachtsmarktkarte"
                    className="text-gold"
            ...
            content: (
              <>
                <p className="text-sm pb-2">
                  ...
                  ist, entstanden in Zusammenarbeit mit dem CityLAB Berlin. Die
                  ODIS wird von der Berliner Senatsverwaltung für Inneres,
                  Digitalisierung und Sport und der Investitionsbank Berlin aus
                  ...
                  </a>. Seit 2018 begleiten wir als ODIS die Stadt auf dem Weg
                  zu einer partizipativen, nachhaltigen und datengetriebenen
                  Gesellschaft mit dem Schwerpunkt auf die Bereitstellung und
                  Nutzung offener Daten. Du hast Feedback oder willst mehr
                  erfahren? Schau dich auf unserer Webseite um oder kontaktiere
                  uns unter{" "}
                  <a href="mailto:leipzig@codefor.de" className="text-gold">
                    leipzig@codefor.de
                  </a>.
                </p>
              </>
        ...
        <Accordion
          items={[{
            ...
            content: (
              <>
                <p className="text-sm pb-2">
                  The Leipzig Christmas Market Finder shows all of Leipzig’s
                  Christmas markets embedded in an interactive map of the city.
                  You can filter the markets by date and attributes like free
                  entry, themed markets with special attractions or proximity to
                  public transport. Once you have found a Christmas market, you
                  can also share it with your friends and colleagues. Based
                  itself on open data, this application demonstrates the
                  importance and usefulness of opening the data held by
                  Leipzig’s public administration. Beyond creating transparency
                  and openness, it allows users to explore the city and come
                  together to spread the Christmas cheer! You can find more open
                  data in the{" "}
                  <a
                    target="blank"
                    href="https://opendata.leipzig.de"
